...
(ueid, authenticationMethod, encPermanentKey, protectionParameterId, sequenceNumber, authenticationManagementField, algorithmId, encOpcKey, n5gcAuthMethod, supi)
VALUES
('001010010002589', '5G_AKA',
'465B5CE8B199B49FAA5F0A2EE238A6BC',
'465B5CE8B199B49FAA5F0A2EE238A6BC',
'{"sqn": "000000000001", "sqnScheme": "NON_TIME_BASED", "lastIndexes": {"ausf": 0}}',
'8000',
'milenage',
...
'{
  "oai": {
    ...
    "staticIpAddress": [{ "ipv4Addr": "10.0.0.2" }]
  }
}');
...
'{
  "oai": {
    ...
    "sessionAmbr": { "uplink": "1000Mbps", "downlink": "1000Mbps" },
    "staticIpAddress": [{ "ipv4Addr": "10.0.0.3" }]
  }
}');
...
'{
  "oai": {
    ...
    "sessionAmbr": { "uplink": "1000Mbps", "downlink": "1000Mbps" },
    "staticIpAddress": [{ "ipv4Addr": "10.0.0.4" }]
  }
}');
...
-- Add missing SmfSelectionSubscriptionData entry for internet connectivity
...
VALUES
('001010010002589', '00101',
'{"subscribedSnssaiInfos": [{"sNssai": {"sst": 1, "sd": "FFFFFF"}, "dnnInfos": [{"dnn": "oai"}, {"dnn": "ims"}]}]}');
